...
![image.jpg1](./image/MINJI_PROFILE_2021.08.jpg) |![image.jpg2](./image/MINJI.jpg) _"나는 커서 뭐가 될까?"_ <br> 먹고 놀기 좋아하고 호기심 많은 개발자ෆ’ᴗ’ෆ <br> 현재는 덕업일치 직장인⚾ <br> 소프트웨어(컴퓨터공학) & 경제 전공 / 취미는 드럼, 야구, 스쿼시 <!-- <br></br>I love computer💻 -->
--- | --- | 
...
| :-------------------: | :---------------: | --------------------------------- | :-------------: |
|   **`🌱Company`**   |     2021.06 ~     | **Back-end Developer** <br>[![CSharp](https://img.shields.io/badge/language-CSharp_·_JavaScript-brightgreen?logo=CSharp)]() [![.NET](https://img.shields.io/badge/framework-ASP.NET_Core_MVC-blueviolet?logo=.NET)]() <br>[![DB](https://img.shields.io/badge/database-MS--SQL_·_MariaDB-blue?logo=MariaDB)]() |    ⚾    |
