...
| :-------------------: | :---------------: | --------------------------------- | :-------------: |
|   **`🌱Company`**   |     2021.06 ~     | **Back-end Developer** <br>[![CSharp](https://img.shields.io/badge/language-CSharp-brightgreen?logo=CSharp)]() [![.NET](https://img.shields.io/badge/framework-.NET-blueviolet?logo=.NET)]() [![DB](https://img.shields.io/badge/database-MS--SQL_·_MariaDB-blue?logo=MariaDB)]() |    ⚾    |
|   **`📚Education`**  | 2020.01 ~ 2020.12 | **SSAFY(SAMSUNG SW ACADEMY FOR YOUTH)** <br>[![Java](https://img.shields.io/badge/language-Java-brightgreen?logo=Java)]() [![Spring](https://img.shields.io/badge/framework-Spring_Boot_·_Vue.js-blueviolet?logo=SpringBoot)]() [![DB](https://img.shields.io/badge/database-MySQL-blue?logo=MySQL)]() |  Samsung  |
