...
| :-------------------: | :---------------: | --------------------------------- | :-------------: |
|   **`🌱Company`**   |     2022.10 ~    | **Software Engineer(디지털개발)** <br>[![Java](https://img.shields.io/badge/language-Java-brightgreen?logo=Java)]() [![DB](https://img.shields.io/badge/database-Oracle-blue?logo=Oracle)]() |    💰    |
